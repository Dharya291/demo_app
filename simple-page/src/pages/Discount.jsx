...
function Discount() {
  ...
  const handleTitleChange = useCallback((value) => setValue(value), []);
  ...
  console.log(productDetails, "54653676");
  return (
    <Page>
      <Grid columns={{ xs: 1 }}>
        <Grid.Cell columnSpan={{ xs: 8, sm: 8, md: 8, lg: 8, xl: 8 }}>
          <div className="grid-cell-wrapper">
            <Card title="Sales" padding={0}>
              <Box paddingBlockEnd={{ lg: "200" }} style={{ padding: "15px" }}>
                    ...
                    <div className="productItems" key={item?.id}>
                      ...
                      >
                        <Button
                          ...
                          variant="primary"
                          tone="critical"
                          onClick={() => handleDeleteProductDetails(item?.id)}
                        />
                      </div>
                    </div>
                  ))}
                <Box paddingBlockStart={{ lg: "200" }}>
                  <Button icon={PlusCircleIcon} onClick={handleProductDetails}>
                    Add Tier
                  </Button>
                </Box>
              </div>
              ...
              <Box className="collectionContainer">
                ...
                <Box paddingBlock={{ lg: "600" }}>
                  {selected === "Specific Products" ? (
                    <ProductsTextField label={selected} />
            ...
            <Card title="Sales">
              <Box paddingBlock={{ lg: "200" }} paddingBlockEnd={{ lg: 400 }}>
                <Text variant="headingLg" as="h5">
                  Combinations
                </Text>
              </Box>
              ...
              <Text>
                Volume discount can be combined with other products, shipping
                and other discounts
              </Text>
            ...
            <Card title="Sales">
              ...
              <InlineGrid columns={2} gap={400}>
                ...
                <TextField
                  ...
                  onChange={(value) => handleWidgetInfo("description", value)}
                  autoComplete="off"
                  type="time"
                  ariaControls="true"
                />
              ...
              {checkedEndTime && <DatePicker label={"End Date"} />}
            </Card>
            <Card title="Sales">
              <Box paddingBlock={{ lg: "400" }}>
                <Text variant="headingLg" as="h5">
              ...
              <Text>
                When not set, the default text from Setting page will be used.
              </Text>
        ...
        <Grid.Cell columnSpan={{ xs: 4, sm: 4, lg: 4, xl: 4 }}>
          <div style={{ position: "sticky", top: "20px" }}>
            <Card title="Sales" sectioned>
              ...
              <Text variant="headingMd" as="h5" tone={!value && "disabled"}>
                {value || "no title"}
              </Text>
              <Box paddingBlock={{ lg: "200" }}>
